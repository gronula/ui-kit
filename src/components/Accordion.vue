  ...
  export default {
    ...
    props: {
      ...
      caretAnimation: {
        ...
        validator: config => {
          const isValid = (typeof config.duration === 'string' && typeof config.timerFunc === 'string') || config.none === true
          return isValid
        }
      },
      dropdown: {
      ...
      icon: {
        ...
        default: 'caret',
        validator: choice => {
          const isValid = choice === 'caret' || choice === 'plus-minus' || choice === 'custom'
          return isValid
        }
      },
      slide: {
        ...
        validator: config => {
          const isValid = typeof config.duration === 'string' && typeof config.timerFunc === 'string'
          return isValid
        }
      }
    },
